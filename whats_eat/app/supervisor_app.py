...
def build_app():
    ...
    supervisor_prompt = (
        ...
        "- Avoid loops: when an agent returns successfully, review its output and pick the NEXT best worker. Do not re-dispatch the same agent unless new information changes the plan.\n"
        ...
        "  • Recommendations: places_user_profile_parallel_agent (wait for its combined output) → recommender_agent or, if knowledge lookup is needed, rag_agent → summarizer_agent\n"
