...
<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB5yMwQo7k6ilAjWviqhVph_UrGKQMXL6Q&callback=initMap"></script>
            ...
            <div className="space-y-5 text-left">
              ...
              <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                ...
                {openStatus && (
                  <div className="rounded-lg border border-slate-200 bg-white p-3">
                    <dt className="mb-1 text-xs uppercase tracking-wide text-slate-500">🕒 Opening hours</dt>
              ...
              {card.tags && card.tags.length > 0 && (
                <div>
                  <p className="mb-2 text-sm uppercase tracking-wide text-slate-500">Highlights</p>
                  <div className="flex flex-wrap gap-1.5">
                    {card.tags.map((tag) => (
                      <span
                        key={`tag-${tag}`}
